        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm mt-4">
              Nemalan, sağlıklı yaşam için nem kontrolü çözümleri sunar.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/sss" className="text-gray-300 hover:text-sky-400 transition-colors">
                  SSS
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-gray-300">
                <p>Email: info@nemalan.com</p>
                <p>Website: nemalan.com</p>
              </div>
            </div>
            <div className="pt-4">
              <h5 className="font-semibold mb-2">Bültenimize Katılın</h5>
              <div className="flex">
                <input
                  type="email"
                  placeholder="E-posta adresiniz"
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-lg text-white placeholder-gray-400 focus:outline-none focus:border-sky-500"
                />
                <button className="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-r-lg transition-colors">
                  Katıl
                </button>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © 2024 NemsizHayat. Tüm hakları saklıdır.
            </div>
